...
const Announcements = () => {
  ...
  const announcements = [
    ...
    { id: 2, title: 'Hackathon Registration Open', date: '2024-12-10', description: 'Sign up now for our annual hackathon and showcase your skills!' },
    { id: 3, title: 'New Mentorship Program', date: '2024-12-01', description: 'Apply for our new mentorship program to get guidance from industry professionals.' },
  ];
